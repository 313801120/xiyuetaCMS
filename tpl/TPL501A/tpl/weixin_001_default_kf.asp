                    ...
                    <div class="child-widget-container">
                        <div class="mip-sjh-wechat">
                            ...
                            <div class="mip-sjh-wechat-wrap"  >
                                <div class="mip-sjh-wechat-wrap-float-one new-icon-btn sjh-wechat-theme-4b534c47-01c1-431e-998c-165373703113" onclick="window.open('/kf.asp?act=loginTourist')" style="transform: scale(1.08); overflow: hidden; transform-origin: right top; border-radius: 9px; cursor:pointer; ">
