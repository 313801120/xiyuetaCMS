...
.pub_page_side_main<%=cssName%> ul,.pub_page_side_main<%=cssName%> ol{
  list-style: none;
  margin: 0;
  padding: 0;
}
...
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list{
    border:1px solid #e5e5e5;
    background:#fff;
    overflow:hidden
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list{
    margin:0
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item{
    margin:0 30px;
    padding:8px 0
}
...
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .imgbox.pic{
    float:left;
    width:150px;
    height:150px;
    margin:4px 0 0
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .intro{
    margin:0 0 0 169px;
    padding-top:20px;
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .intro .news_title{
    margin:0;
    font-size:15px;
    white-space:nowrap;
    overflow:hidden;
...
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .intro .news_title a{
    color:#0d62be;
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .intro .news_brief{
    min-height:50px;
    margin:12px 0;
    font-size:14px;
    line-height:1.6;
...
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .intro .news_status_list{
    margin:10px 0
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .intro .news_status_list .news_status_time{
    margin:10px 0;
    color:#326ec0;
    font-size:14px;
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item .intro .news_status_list .news_status_time .ico.ico_clock{
    display:inline-block;
    width:16px;
    height:16px;
    margin:0 8px 0 0;
    vertical-align:middle;
    background:url(<%=resurl%>images/page_news_ico_clock.png)
}
.pub_page_side_main<%=cssName%> .cnt .pub_page_main .page_news_list .news_list .news_item{
...
%>
                        <div class="news_item">
                            <a class="imgbox pic" href="<%=getArticleUrl(rs("id"))%>">
                                <img src="<%=rs("smallImage")%>" alt="<%=rs("title")%>" onerror="this.src='/uploadfiles/testpic/nopic.png'" /></a>
                            <div class="intro">
                                <div class="news_title">
                                    <a href="<%=getArticleUrl(rs("id"))%>" title="<%=rs("title")%>"><%=rs("title")%></a>
                                </div>
