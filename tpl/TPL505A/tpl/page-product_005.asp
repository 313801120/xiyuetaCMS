...
.sub-content-fluid<%=cssName%> .product-item{
    float: left;
    width: 25%;
    padding: 10px;
}
.sub-content-fluid<%=cssName%> .product-item a{
    display: block;
    width: 100%;
    border: 1px solid #ddd;
}
.sub-content-fluid<%=cssName%> .product-item a .product-img{
    width: 100%;
    overflow: hidden;
}
.sub-content-fluid<%=cssName%> .product-item a .product-img img{
    width: 100%;
}
.sub-content-fluid<%=cssName%> .product-info{
    width: 100%;
    text-align: center;
...
.sub-content-fluid<%=cssName%> .product-item a:hover .product-info{
    color:  #0d62be;
}
.sub-content-fluid<%=cssName%>{
    padding: 50px 0px;
...
.sub-content-fluid<%=cssName%> .sub-sidebar-list ul li a i.mw-iconfont{
    margin-right: 5px;
}
...
%>
                     <div class="product-item">
                        <a href="<%=getArticleUrl(rs("id"))%>">
                            <div class="product-img"><img src="<%=rs("smallimage")%>" onerror="this.src='/uploadfiles/testpic/nopic.png'" style="height: 135.1px;">
                            </div>
