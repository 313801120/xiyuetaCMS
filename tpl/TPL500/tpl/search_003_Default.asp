...
.yunu-sou<%=cssName%> a:hover{color: #007333;text-decoration: none;}
...
.yunu-sou<%=cssName%> .hot strong{color: #007333;}
...
.yunu-sou<%=cssName%> .hform button{border: 0;border-bottom: 1px solid transparent;padding: 0;float: left;cursor: pointer;outline: none;width: 49px;height: 30px;background: #007333;color: #fff;}
