...
.kefu .kefu-tel-main{background:#007333;color:#fff;height:71px;width:247px;padding:9px 0 6px;float:left;}
.kefu .kefu-main{background:#007333;width:97px;height:71px;position:relative;padding:9px 0 6px;float:left;}
