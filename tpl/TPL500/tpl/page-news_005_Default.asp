...
.container<%=cssName%> a:hover{color: #007333;text-decoration: none;}
...
.container<%=cssName%> .list-4 li .more{float: right;line-height: 36px;width: 90px;text-align: center;background-color: #ec5b43;color: #fff;margin-top: 20px;}
...
.container<%=cssName%> .list-4 li:nth-of-type(even) a{background-color: #fdeae7;}
...
.container<%=cssName%> .pages a:hover,.container<%=cssName%> .pages a.active{background-color: #007333;color: #fff;}
