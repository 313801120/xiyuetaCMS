...
.footerwrap<%=cssName%> a:hover{color: #007333;}
.footerwrap<%=cssName%> ul{margin: 0;list-style: none;padding: 0;}
.footerwrap<%=cssName%> .yunu-footer-fix{position: fixed;bottom: 0;left: 0;width: 100%;background-color: #007333;z-index: 500;display: none;}
...
.footerwrap<%=cssName%> .footer-link{text-align: center;font-size: 0;background-color: #007333;line-height: 50px;margin-bottom: 30px;}
...
.footerwrap<%=cssName%> .footer{padding: 20px 0;background-color: #333;color: #fff;text-align: center;}
