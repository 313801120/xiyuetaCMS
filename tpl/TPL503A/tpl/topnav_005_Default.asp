...
.header<%=cssName%> a:hover{color: #0d62be;text-decoration: none;}
...
.header<%=cssName%> .tel strong{display: block;font-size: 28px;font-family: Impact;line-height: 1;color: #0d62be;}
...
.header<%=cssName%> .nav{font-size: 0;background-color: #0d62be;color: #fff;}
...
.header<%=cssName%> .nav .dropdown-box a:hover{background-color: #0d62be !important;}
.header<%=cssName%> .nav li.active a,.header<%=cssName%> .nav li.open a,.header<%=cssName%> .nav li a:hover{color: #fff;background-color: #326ec0;}
.header<%=cssName%> .menu-btn{display: none;padding: 6px 0;float: right;margin-left: 15px;}
.header<%=cssName%> .menu-btn:before,.header<%=cssName%> .menu-btn:after,.header<%=cssName%> .menu-btn span{display: block;height: 2px;background-color: #0d62be;content: '';}
...
.header<%=cssName%> .nav li.active a,.header<%=cssName%> .nav li.open a,.header<%=cssName%> .nav li a:hover{background-color: transparent;color: #0d62be}
