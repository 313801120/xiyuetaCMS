...
.container<%=cssName%> button,.container<%=cssName%> input,.container<%=cssName%> optgroup,.container<%=cssName%> select,.container<%=cssName%> textarea{line-height:1.42857143;margin:0;outline: none;}
...
.container<%=cssName%> button,.container<%=cssName%> input{overflow:visible;border: 1px solid #ddd;}
.container<%=cssName%> [type=reset],.container<%=cssName%> [type=submit]{-webkit-appearance:button;}
.container<%=cssName%> button::-moz-focus-inner,.container<%=cssName%> [type=button]::-moz-focus-inner,.container<%=cssName%> [type=reset]::-moz-focus-inner,.container<%=cssName%> [type=submit]::-moz-focus-inner{border-style:none;padding:0;}
.container<%=cssName%> button:-moz-focusring,.container<%=cssName%> [type=button]:-moz-focusring,.container<%=cssName%> [type=reset]:-moz-focusring,.container<%=cssName%> [type=submit]:-moz-focusring{outline:1px dotted ButtonText;}
.container<%=cssName%> textarea{overflow:auto;border: 1px solid #ddd;}
