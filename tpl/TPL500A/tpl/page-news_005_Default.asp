...
.container<%=cssName%> a:hover{color: #0d62be;text-decoration: none;}
...
.container<%=cssName%> .panel-sd .tit{text-align: center;color: #fff;line-height: 50px;font-size: 18px;background: -webkit-linear-gradient(bottom, #0d62be, #005a8c);
    background: -moz-linear-gradient(bottom, #0d62be, #005a8c);
    background: -o-linear-gradient(bottom, #0d62be, #005a8c);
    background: linear-gradient(bottom, #0d62be, #005a8c);}
...
.container<%=cssName%> .lanmu li>a:hover,.container<%=cssName%> .lanmu li.active>a{background: #326ec0;color: #fff;}
...
.container<%=cssName%> .list-3 li a:hover{background-color: #0d62be;color: #fff;}
.container<%=cssName%> .list-3 li a:hover .img-center img{transform: scale(1.8);}
.container<%=cssName%> .contact-sd{padding: 15px;}
.container<%=cssName%> .contact-sd h4{margin: 0;color: #0d62be;}
.container<%=cssName%> .contact-sd p{font-size: 12px;border-top: 1px dotted #ddd;margin: 8px 0 0;padding-top: 8px;}
.container<%=cssName%> .position{margin-bottom: 15px;border: 1px solid #efefef;border-left: 3px solid #0d62be;padding: 8px 0 8px 10px;background: #fafafa;}
.container<%=cssName%> .mn-box{border: 1px solid #efefef;padding: 20px;margin-bottom: 15px;}
.container<%=cssName%> .list-4 li{margin-bottom: 10px;}
.container<%=cssName%> .list-4 li a{display: block;overflow: hidden;padding: 20px;background-color: #f5f5f5;}
.container<%=cssName%> .list-4 li .more{float: right;line-height: 36px;width: 90px;text-align: center;background-color: #0d62be;color: #fff;margin-top: 20px;}
.container<%=cssName%> .list-4 li .date{float: left;width: 76px;background-color: #fff;text-align: center;padding: 14px 0;}
.container<%=cssName%> .list-4 li .date strong{display: block;font-family: Impact;font-size: 24px;line-height: 1;margin-bottom: 5px;}
.container<%=cssName%> .list-4 li .text{margin: 0 110px 0 95px;}
.container<%=cssName%> .list-4 li .text h4{font-size: 14px;margin: 0;white-space: nowrap;overflow: hidden;text-overflow: ellipsis;font-size: 16px;}
.container<%=cssName%> .list-4 li .text p{margin: 5px 0 0;line-height: 1.8;height: 50px;overflow: hidden;color: #666;text-align: justify;}
.container<%=cssName%> .list-4 li:nth-of-type(even) a{background-color: #edefff;}
.container<%=cssName%> .pages{margin: 20px 0 0;text-align: center;font-size: 0;}
.container<%=cssName%> .pages a{display: inline-block;font-size: 14px;line-height: 35px;padding: 0 14px;margin: 5px;background-color: #f5f5f5;border-radius: 3px;-webkit-transition: all 0.5s;transition: all 0.5s;}
.container<%=cssName%> .pages a:hover,.container<%=cssName%> .pages a.active{background-color: #0d62be;color: #fff;}
.container<%=cssName%> .panel-mn{border: 1px solid #efefef;margin-bottom: 15px;border-top: 2px solid #0d62be;}
.container<%=cssName%> .panel-mn .tit{padding: 0 20px;background: -webkit-linear-gradient(bottom, #f5f5f5, #eee);
    background: -moz-linear-gradient(bottom, #f5f5f5, #eee);
    background: -o-linear-gradient(bottom, #f5f5f5, #eee);
    background: linear-gradient(bottom, #f5f5f5, #eee);line-height: 44px;font-weight: bold;color: #0d62be;}
...
.container<%=cssName%> .list-6 li .img-cover{border: 2px solid #0d62be;transition: all 0.5s;}
...
.container<%=cssName%> .list-6 li a:hover .img-cover{border-color: #0d62be;}
...
.container<%=cssName%> .list-4 li a{padding: 10px;}
.container<%=cssName%> .list-4 li .more{display: none;}
.container<%=cssName%> .list-4 li .date{font-size: 12px;width: 60px;padding: 10px 0;}
.container<%=cssName%> .list-4 li .date strong{font-size: 18px;}
.container<%=cssName%> .list-4 li .text{margin: 0 0 0 70px;}
.container<%=cssName%> .list-4 li .text h4{font-size: 14px;}
.container<%=cssName%> .list-4 li .text p{font-size: 12px;height: 42px;margin-top: 2px;}
.container<%=cssName%> .pages{margin-top: 15px;}
.container<%=cssName%> .pages a{font-size: 12px;line-height: 30px;padding: 0 12px;}
...
.container<%=cssName%> .pagination{
overflow: hidden;
}
.container<%=cssName%> .pagination a{
display:block;
float:left;
margin-right:0px;
padding:2px 12px;
...
.container<%=cssName%> .pagination a:hover{
color:#fff;
background:#0d62be;
border:1px #0d62be solid;
}
.container<%=cssName%> .pagination a.cur{
border:none;
background:#0d62be;
color:#fff;
border:1px #0d62be solid;
...
%>
                    ...
                    <li>
                        <a href="<%=getArticleUrl(rs("id"))%>">
                            ...
                            <div class="date">
                                <strong><%=day(rs("createTime"))%></strong><%=format_Time(rs("createTime"),30)%>
                            </div>
                            <div class="text">
            ...
            for i=page-2 to page+2
                if i>0 and i<=maxpage then
                    if i=page then
                        response.Write("<a class=""cur"">"& i &"</a>")
                    else
