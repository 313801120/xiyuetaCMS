...
layui.define("view", function(e) {
    var a = layui.jquery,
        ...
        P = {
            ...
            sendAuthCode: function(e) {
                ...
                var t, i = e.seconds,
                    n = a(e.elem),
                    l = function(a) { i--, i < 0 ? (n.removeClass(f).html("获取验证码"), i = e.seconds, clearInterval(t)) : n.addClass(f).html(i + "秒后重获"), a || (t = setInterval(function() { l(!0) }, 1e3)) };
            ...
            theme: function(e) {
                ...
                "styleSheet" in s ? (s.setAttribute("type", "text/css"), s.styleSheet.cssText = r) : s.innerHTML = r, s.id = l, u && o[0].removeChild(u), o[0].appendChild(s), o.attr("layadmin-themealias", e.color.alias), i.theme = i.theme || {}, layui.each(e, function(e, a) { i.theme[e] = a }), layui.data(n.tableName, { key: "theme", value: i.theme })
            },
            ...
            note: function(e) {
                ...
                F.note.index = P.popup({
                    ...
                    success: function(e, a) {
                        ...
                        i.val(l).focus().on("keyup", function() { layui.data(n.tableName, { key: "note", value: this.value }) })
                    }
                })
            },
    ...
    }(), i.on("tab(" + p + ")", function(e) { P.tabsPage.index = e.index }), P.on("tabsPage(setMenustatus)", function(e) {
        var t = e.url,
            i = function(e) { return { list: e.children(".layui-nav-child"), a: e.children("*[lay-href]") } },
            n = a("#" + k),
            l = "layui-nav-itemed",
            s = function(e) {
                e.each(function(e, n) {
    ...
    }), i.on("nav(layadmin-system-side-menu)", function(e) { e.siblings(".layui-nav-child")[0] && u.hasClass(C) && (P.sideFlexible("spread"), layer.close(e.data("index"))), P.tabsPage.type = "nav" }), i.on("nav(layadmin-pagetabs-nav)", function(e) {
        var a = e.parent();
    ...
    o.on("click", _, function() {
        ...
        if (!e.parent().hasClass("layui-nav-item") || u.hasClass(C)) {
            var t = e.attr("lay-tips"),
                ...
                l = layer.tips(t, this, { tips: n || 1, time: -1, success: function(e, a) { i && e.css("margin-left", i + "px") } });
            e.data("index", l)
        }
