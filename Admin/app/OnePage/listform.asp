...
winTitle = ChrW(21333)&ChrW(39029)
dim msg,isTrue,addSql,id,title,bodycontent,smallimage,isthrough,en_bodycontent
...
<button type="button" class="layui-btn layui-btn-primary" id="layuiadmin-upload-001">        <i class="layui-icon">&#xe67c;</i>上传图片</button>
<input class="layui-upload-file" type="file" accept="" name="file">
<button type="button" class="layui-btn layui-btn-primary" layadmin-event="avartatPreview">查看图片</button >    </div>
<div class='layui-form-item'>
...
<div class='layui-input-block'>
<textarea name='en_bodycontent' <%=IIF(request(ChrW(101)&ChrW(100)&ChrW(105)&ChrW(116)&ChrW(111)&ChrW(114)) <>ChrW(110)&ChrW(111),ChrW(32)&ChrW(105)&ChrW(100)&ChrW(61)&ChrW(39)&ChrW(101)&ChrW(110)&ChrW(95)&ChrW(98)&ChrW(111)&ChrW(100)&ChrW(121)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(116)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(39),"")%> placeholder='请输入英文内容' class='layui-textarea'style='height:300px'><%=en_bodycontent%></textarea>
</div><!--en_bodycontent-->
</div>
</div>
<%end if%>
