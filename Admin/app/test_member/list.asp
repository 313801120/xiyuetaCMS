...
if instr(ChrW(124)&ChrW(105)&ChrW(100)&ChrW(124)&ChrW(110)&ChrW(105)&ChrW(99)&ChrW(107)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(124)&ChrW(115)&ChrW(101)&ChrW(120)&ChrW(124)&ChrW(117)&ChrW(115)&ChrW(101)&ChrW(114)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(124)&ChrW(116)&ChrW(101)&ChrW(108)&ChrW(124)&ChrW(101)&ChrW(109)&ChrW(97)&ChrW(105)&ChrW(108)&ChrW(124)&ChrW(105)&ChrW(115)&ChrW(116)&ChrW(104)&ChrW(114)&ChrW(111)&ChrW(117)&ChrW(103)&ChrW(104)&ChrW(124)&ChrW(98)&ChrW(111)&ChrW(100)&ChrW(121)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(116)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(124)&ChrW(124), ChrW(124)& lcase(b) &ChrW(124))=false then  
...
<!-- 下拉菜单 -->
<script type="text/html" id="TPL-dropdpwn-usertype">
<button class="layui-btn layui-btn-primary dropdpwn-usertype">
<span>        <span>  
{{# if(d.usertype === '普通会员'){ }}
普通会员
{{# } else if(d.usertype === '高级会员'){ }}
高级会员
{{# } else if(d.usertype === '超级会员'){ }}
超级会员
{{# } }}
</span></span>
<i class="layui-icon layui-icon-down layui-font-12"></i>
...
,{ field: 'sex', title: '性别',width:120, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-sex'}
,{ field: 'usertype', title: '会员类型',minWidth:180, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-usertype'}
...
// dropdown 方式的下拉选择
var usertypeOptions = [
{id: 100, title: '普通会员', value: '普通会员'},
{id: 101, title: '高级会员', value: '高级会员'},
{id: 102, title: '超级会员', value: '超级会员'}
];
dropdown.render({
elem: '.dropdpwn-usertype',
// trigger: 'hover',
// 此处的 data 值，可根据 done 返回的 res 遍历来赋值
data: usertypeOptions,
click: function(obj){
var data = table.getRowData(options.id, this.elem); // 获取当前行数据(如 id 等字段，以作为数据修改的索引)                
var tempData=data.usertype;//原值 
var This=this;
This.elem.find('span').html(obj.title); 
submitOnLineEdit(data.id,'usertype',obj.value).then(data => {  
if(data.status=="n"){  // 为假，恢复原来的值 
layer.tips(data.info, This.elem, {tips: 1});
// 查找title
var sText = '';
for(var i=0; i<usertypeOptions.length; i++){
if(usertypeOptions[i].value == tempData){
sText = usertypeOptions[i].title;
break;
}
}
This.elem.find('span').html(sText); 
...
}else if (obj.event === 'click_usertype') {       //会员类型
showwin('会员类型', '/admin/app/test_xiyuetaclass/list.asp?id='+data.parentid)   
}
}); 
// 工具栏事件
