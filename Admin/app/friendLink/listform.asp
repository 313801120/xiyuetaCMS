...
<div class='layui-input-inline'>
<input type='text' name='httpurl' placeholder='请输入网址'autocomplete='off' class='layui-input' value="<%=httpurl%>" >
</div><!--httpurl-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>缩略图</label>
<div class='layui-input-inline'>
<input type='text' name='smallimage' placeholder='请输入缩略图'autocomplete='off' class='layui-input' value="<%=smallimage%>" >
</div><!--smallimage-->
...
<div class='layui-input-inline'>
<input type="checkbox" lay-filter="switch" name="nofollow" lay-skin="switch" lay-text="设置nofollow|不设置nofollow" <%=IIF(nofollow=0,"",ChrW(32)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)&ChrW(101)&ChrW(100))%>>
</div><!--nofollow-->
</div>
<div class='layui-form-item'>
