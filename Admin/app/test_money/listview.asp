...
dim msg,isTrue,sql,addSql,id,inadminid,userid,price,daytime,bodycontent,smallimage,pic2,pic3,isthrough,createtime,updatetime,ip,tsfield_addr,adminid
...
price=printMoneySignColor(rs,rs(ChrW(112)&ChrW(114)&ChrW(105)&ChrW(99)&ChrW(101)))
...
<%=get_admin_oneClassColumnName(inadminid)%>
</div><!--inadminid-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>客户：</label>
<div class='layui-input-block layui-input-wrap'>
<%=get_member_oneClassColumnName(userid)%>
</div><!--userid-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-block layui-input-wrap'>
<a href="<%=pic2%>" target="_blank" title="点击查看"><%=IIF(pic2 <>"",pic2,"")%></a>
</div><!--pic2-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>图片3：</label>
<div class='layui-input-block layui-input-wrap'>
<a href="<%=pic3%>" target="_blank" title="点击查看"><%=IIF(pic3 <>"",pic3,"")%></a>
</div><!--pic3-->
</div>
<div class='layui-form-item'>
