...
dim msg,isTrue,sql,addSql,id,adminroleid,username,nickname,sex,grouping,tel,email,pic,isthrough,iplimitlist,bodycontent
...
function get_xiyuetaclass_allTreeName(a) 
dim b,c,d
...
for b=1 to 10
e.open ChrW(115)&ChrW(101)&ChrW(108)&ChrW(101)&ChrW(99)&ChrW(116)&ChrW(32)&ChrW(42)&ChrW(32)&ChrW(102)&ChrW(114)&ChrW(111)&ChrW(109)&ChrW(32)& getTableFieldFuHao(db_PREFIX &ChrW(120)&ChrW(105)&ChrW(121)&ChrW(117)&ChrW(101)&ChrW(116)&ChrW(97)&ChrW(99)&ChrW(108)&ChrW(97)&ChrW(115)&ChrW(115))&ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(105)&ChrW(100)&ChrW(61)&a,conn,1,1
if not e.eof then
a=e(ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100))
d=e(ChrW(99)&ChrW(111)&ChrW(108)&ChrW(117)&ChrW(109)&ChrW(110)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101))& ChrW(40)&e(ChrW(105)&ChrW(100))&ChrW(41)
if c <>"" then d= d & ChrW(62)&ChrW(62)
c=d&c
if a=-1 or isNul(a) then exit for
end if:e.close 
next
get_xiyuetaclass_allTreeName=c
end function
%> 
...
<%=get_admin_role_oneClassColumnName(adminroleid)%>
</div><!--adminroleid-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-block layui-input-wrap'>
<%=getOnLineSelectValue(ChrW(115)&ChrW(101)&ChrW(120)&ChrW(45)&ChrW(30007)&ChrW(95)&ChrW(49)&ChrW(45)&ChrW(22899)&ChrW(95)&ChrW(50)&ChrW(45)&ChrW(20445)&ChrW(23494)&ChrW(95)&ChrW(48),sex)%>
</div><!--sex-->
</div>
<%end if%>
<div class='layui-form-item'>
...
<div class='layui-input-block layui-input-wrap'>
<%=get_xiyuetaclass_allTreeName(grouping)%>
</div><!--grouping-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-block layui-input-wrap'>
<a href="<%=pic%>" target="_blank" title="点击查看"><%=IIF(pic <>"",pic,"")%></a>
</div><!--pic-->
</div>
<div class='layui-form-item'>
