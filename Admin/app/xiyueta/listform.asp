...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(117)&ChrW(115)&ChrW(101)&ChrW(114)&ChrW(105)&ChrW(100)&ChrW(61)& userid &""
if id <>"" then
...
<input type='text' name='adminid' placeholder='请输入管理ID' autocomplete='off' class='layui-input' value="<%=adminid%>" >
</div><!--adminid-->
</div>
...
<div class='layui-input-inline'>
<input type='number' name='userid' placeholder='请输入用户ID' autocomplete='off' class='layui-input' value="<%=userid%>"  lay-verify='required'>
</div><!--userid-->
</div>
</div>
<%end if%>
