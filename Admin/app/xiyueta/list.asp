...
,{ field: 'adminid', title: '管理ID',width:160, sort: true ,edit:editable}
,{ field: 'userid', title: '用户ID',minWidth:200, sort: true ,edit:editable}
,{ field: 'sortrank', title: '排序', sort: true }
