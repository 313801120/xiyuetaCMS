...
{{# if(d.saction === 'add'){ }}
添加
{{# } else if(d.saction === 'batchdel'){ }}
批量删除
{{# } else if(d.saction === 'batchCopy'){ }}
批量复制
{{# } else if(d.saction === 'batchEdit'){ }}
批量修改
{{# } else if(d.saction === 'cls'){ }}
清空数据
...
,{ field: 'tsfieldlayoutpage', title: '布局页',minWidth:350, sort: true , templet:function(d){return '<span style="cursor: pointer;" lay-event="click_tsfieldlayoutpage" title="点击布局页">'+d.tsfieldlayoutpage+'</span>'}}
,{ field: 'title', title: '标题',minWidth:100, sort: false ,edit:editable}
,{ field: 'buttontitle', title: '按钮标题',minWidth:120, sort: false ,edit:editable}
,{ field: 'saction', title: '选择动作',minWidth:180, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-saction'}
...
,{ field: 'noteico', title: '注释图标',minWidth:180, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-noteico'}
,{ field: 'notetext', title: '注释文本',width:100, sort: false ,edit:editable}
...
// dropdown 方式的下拉选择
var sactionOptions = [
{id: 100, title: '添加', value: 'add'},
{id: 101, title: '批量删除', value: 'batchdel'},
{id: 102, title: '批量复制', value: 'batchCopy'},
{id: 103, title: '批量修改', value: 'batchEdit'},
{id: 104, title: '清空数据', value: 'cls'},
{id: 105, title: '自定义', value: 'customize'}
];
dropdown.render({
...
}else if (obj.event === 'click_tsfieldlayoutpage') {       //布局页(tsfield自定义字段)
showwin('布局页', '/admin/app/test_layout_page/listform.asp?id='+data.layout_page_id)   
}
}); 
// 工具栏事件
