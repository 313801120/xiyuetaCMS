...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(108)&ChrW(97)&ChrW(121)&ChrW(111)&ChrW(117)&ChrW(116)&ChrW(95)&ChrW(112)&ChrW(97)&ChrW(103)&ChrW(101)&ChrW(95)&ChrW(105)&ChrW(100)&ChrW(61)& layout_page_id &ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(61)&ChrW(39)& title &ChrW(39)
if id <>"" then
...
<input type="radio" name="saction" value="add" title="添加" lay-filter="saction" <%=IIF(saction+""=ChrW(97)&ChrW(100)&ChrW(100),ChrW(32)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)&ChrW(101)&ChrW(100),"")%>>
<input type="radio" name="saction" value="batchdel" title="批量删除" lay-filter="saction" <%=IIF(saction+""=ChrW(98)&ChrW(97)&ChrW(116)&ChrW(99)&ChrW(104)&ChrW(100)&ChrW(101)&ChrW(108),ChrW(32)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)&ChrW(101)&ChrW(100),"")%>>
<input type="radio" name="saction" value="batchCopy" title="批量复制" lay-filter="saction" <%=IIF(saction+""=ChrW(98)&ChrW(97)&ChrW(116)&ChrW(99)&ChrW(104)&ChrW(67)&ChrW(111)&ChrW(112)&ChrW(121),ChrW(32)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)&ChrW(101)&ChrW(100),"")%>>
<input type="radio" name="saction" value="batchEdit" title="批量修改" lay-filter="saction" <%=IIF(saction+""=ChrW(98)&ChrW(97)&ChrW(116)&ChrW(99)&ChrW(104)&ChrW(69)&ChrW(100)&ChrW(105)&ChrW(116),ChrW(32)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)&ChrW(101)&ChrW(100),"")%>>
<input type="radio" name="saction" value="cls" title="清空数据" lay-filter="saction" <%=IIF(saction+""=ChrW(99)&ChrW(108)&ChrW(115),ChrW(32)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)&ChrW(101)&ChrW(100),"")%>>
...
<div class="layui-form-mid layui-text-em">batcratepage为生成布局页，复制和删除动作下layoutPage为复制和删除的时候再加强处理</div><!--customizeaction-->
</div>
