...
dim msg,isTrue,sql,addSql,id,articleid,stype,count,ip
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100)&ChrW(61)& articleid &ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(105)&ChrW(112)&ChrW(61)&ChrW(39)& ip &ChrW(39)&ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(115)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(61)&ChrW(39)&stype&ChrW(39)&ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(105)&ChrW(112)&ChrW(61)&ChrW(39)& ip &ChrW(39)&ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&getAccessDatediffTime(ChrW(99)&ChrW(114)&ChrW(101)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(116)&ChrW(105)&ChrW(109)&ChrW(101),now())&ChrW(61)&ChrW(48)
if id <>"" then
...
if not rs.eof then
msg=ChrW(24403)&ChrW(21069)&ChrW(73)&ChrW(80)&ChrW(20170)&ChrW(22825)&ChrW(24050)&ChrW(32463)&ChrW(28155)&ChrW(21152)&ChrW(36807)
else
if id="" then
rs.addnew
else
...
<div class='layui-input-inline'>
<input type='text' name='stype' placeholder='请输入类型'autocomplete='off' class='layui-input' value="<%=stype%>" >
</div><!--stype-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>统计数</label>
<div class='layui-input-inline'>
<input type='text' name='count' placeholder='请输入统计数'autocomplete='off' class='layui-input' value="<%=count%>" >
</div><!--count-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>IP</label>
<div class='layui-input-inline'>
<input type='text' name='ip' placeholder='请输入IP'autocomplete='off' class='layui-input' value="<%=ip%>" >
</div><!--ip-->
</div>
</div>
<%if checkEnLanguage() then%>
