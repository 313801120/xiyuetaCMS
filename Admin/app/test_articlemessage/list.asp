...
if instr(ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100)&ChrW(124)&ChrW(103)&ChrW(117)&ChrW(101)&ChrW(115)&ChrW(116)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(124)&ChrW(116)&ChrW(101)&ChrW(108)&ChrW(124)&ChrW(101)&ChrW(109)&ChrW(97)&ChrW(105)&ChrW(108)&ChrW(124)&ChrW(98)&ChrW(111)&ChrW(100)&ChrW(121)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(116)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(124)&ChrW(105)&ChrW(112)&ChrW(124)&ChrW(105)&ChrW(115)&ChrW(116)&ChrW(104)&ChrW(114)&ChrW(111)&ChrW(117)&ChrW(103)&ChrW(104)&ChrW(124)&ChrW(124), ChrW(124)& lcase(b) &ChrW(124))=false then  
...
,{ field: 'parentid', title: '给TA回复',width:110, sort: false ,edit:editable}
,{ field: 'guestname', title: '姓名', sort: false ,edit:editable}
,{ field: 'tel', title: '电话', sort: false ,edit:editable}
,{ field: 'email', title: '邮箱', sort: false ,edit:editable}
,{ field: 'tsfield_articlemessageid001', title: '留言统计',width:110, sort: true , templet:function(d){return '<span style="cursor: pointer;" lay-event="click_tsfield_articlemessageid001" title="点击留言统计">'+d.tsfield_articlemessageid001+'</span>'}}
,{ field: 'ip', title: 'IP',width:140, sort: false ,edit:editable}
,{ field: 'tsfield_addr', title: 'IP地址',minWidth:200, sort: false }
...
,{title: '浏览文章',id: 'customize-35cd628a00af6055'}],
...
}else if (menudata.id === 'customize-35cd628a00af6055') {       //浏览文章
showwin3('浏览文章','/detail.asp?id='+obj.data['tsfield_articleid'])
}
},
align: 'right', // 右对齐弹出
...
}else if (obj.event === 'click_tsfield_articlemessageid001') {       //文章留言统计表
showwin3('留言统计', '/admin/app/test_articlemessagecount/list.asp?articlemessageid='+data.id)   
}
}); 
// 工具栏事件
...
break;
case 'add':
showwin('添加<%=winTitle%>','listform.asp?articleid=<%=request(ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100))%>')
break;                
case 'LAYTABLE_DRDC':
// 更多 - 下拉菜单
dropdown.render({
