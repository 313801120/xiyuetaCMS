...
function get_layout_listPage_form_treeName(a,b)
dim c:Set c = CreateObject(ChrW(65)&ChrW(100)&ChrW(111)&ChrW(100)&ChrW(98)&ChrW(46)&ChrW(82)&ChrW(101)&ChrW(99)&ChrW(111)&ChrW(114)&ChrW(100)&ChrW(83)&ChrW(101)&ChrW(116))
...
if c(ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100)) <>-1 then
call get_layout_listPage_form_treeName(c(ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100)),b)
end if
end if:c.close
get_layout_listPage_form_treeName=b
end function
...
function get_layout_listPage_form_columnName(a,b)
dim c,d
d=a(b)
if d <>-1 then
c=get_layout_listPage_form_treeName(d,"")  & a(ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101))& ChrW(40)&a(ChrW(105)&ChrW(100))&ChrW(41)
else
c=a(ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101))& ChrW(40)&a(ChrW(105)&ChrW(100))&ChrW(41)
end if
get_layout_listPage_form_columnName=jsonCL(c)
end function
...
if instr(ChrW(124)&ChrW(105)&ChrW(100)&ChrW(124)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(124)&ChrW(98)&ChrW(117)&ChrW(116)&ChrW(116)&ChrW(111)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(124)&ChrW(105)&ChrW(110)&ChrW(112)&ChrW(117)&ChrW(116)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(124)&ChrW(102)&ChrW(105)&ChrW(101)&ChrW(108)&ChrW(100)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(124)&ChrW(115)&ChrW(97)&ChrW(99)&ChrW(116)&ChrW(105)&ChrW(111)&ChrW(110)&ChrW(124)&ChrW(100)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(98)&ChrW(106)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(124)&ChrW(99)&ChrW(117)&ChrW(115)&ChrW(116)&ChrW(111)&ChrW(109)&ChrW(105)&ChrW(122)&ChrW(101)&ChrW(97)&ChrW(99)&ChrW(116)&ChrW(105)&ChrW(111)&ChrW(110)&ChrW(124)&ChrW(100)&ChrW(101)&ChrW(102)&ChrW(97)&ChrW(117)&ChrW(108)&ChrW(116)&ChrW(118)&ChrW(97)&ChrW(108)&ChrW(117)&ChrW(101)&ChrW(124)&ChrW(115)&ChrW(111)&ChrW(114)&ChrW(116)&ChrW(114)&ChrW(97)&ChrW(110)&ChrW(107)&ChrW(124)&ChrW(105)&ChrW(115)&ChrW(116)&ChrW(104)&ChrW(114)&ChrW(111)&ChrW(117)&ChrW(103)&ChrW(104)&ChrW(124)&ChrW(98)&ChrW(103)&ChrW(99)&ChrW(111)&ChrW(108)&ChrW(111)&ChrW(114)&ChrW(124)&ChrW(110)&ChrW(111)&ChrW(116)&ChrW(101)&ChrW(105)&ChrW(99)&ChrW(111)&ChrW(124)&ChrW(110)&ChrW(111)&ChrW(116)&ChrW(101)&ChrW(116)&ChrW(101)&ChrW(120)&ChrW(116)&ChrW(124)&ChrW(124), ChrW(124)& lcase(b) &ChrW(124))=false then  
...
<option value="sAction">表单列表(sAction)</option>
...
{{# if(d.saction === 'date'){ }}
时间
{{# } else if(d.saction === 'searchInput'){ }}
搜索框
{{# } else if(d.saction === 'fieldType'){ }}
字段选择
{{# } else if(d.saction === 'orderSelect'){ }}
排序选择
{{# } else if(d.saction === 'submit'){ }}
提交按钮
{{# } else if(d.saction === 'label'){ }}
标签
{{# } else if(d.saction === 'line'){ }}
分割线
{{# } else if(d.saction === 'button'){ }}
按钮
{{# } else if(d.saction === 'onlineSelect'){ }}
下拉菜单
{{# } else if(d.saction === 'customize'){ }}
自定义
{{# } else if(d.saction === 'defaultValue'){ }}
默认值
{{# } }}
</span></span>
...
<!-- 下拉菜单 -->
<script type="text/html" id="TPL-dropdpwn-datebjtype">
<button class="layui-btn layui-btn-primary dropdpwn-datebjtype">
<span>        <span>  
{{# if(d.datebjtype === ''){ }}
无
{{# } else if(d.datebjtype === '>'){ }}
>
{{# } else if(d.datebjtype === '='){ }}
=
{{# } else if(d.datebjtype === '<'){ }}
...
{ field: 'id', title: 'ID',width:80, sort: false ,edit:editable}
,{ field: 'layout_page_id', title: '布局页ID',minWidth:230, sort: false , templet:function(d){return '<span style="cursor: pointer;" lay-event="click_layout_page_id" title="点击布局页ID">'+d.layout_page_id+'</span>'}}
,{ field: 'parentid', title: '选择分类',minWidth:180, sort: false , templet:function(d){return '<span style="cursor: pointer;" lay-event="click_parentid" title="点击选择分类">'+d.parentid+'</span>'}}
...
,{ field: 'inputname', title: 'input名',width:100, sort: false ,edit:editable}
,{ field: 'fieldname', title: '字段名称',minWidth:120, sort: false ,edit:editable}
,{ field: 'saction', title: '表单列表',minWidth:200, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-saction'}
,{ field: 'datebjtype', title: '时间比较',width:110, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-datebjtype'}
,{ field: 'customizeaction', title: '自定义动作',width:100, sort: false ,edit:editable}
,{ field: 'defaultvalue', title: '默认值',width:90, sort: false ,edit:editable}
...
// dropdown 方式的下拉选择
var sactionOptions = [
{id: 100, title: '时间', value: 'date'},
{id: 101, title: '搜索框', value: 'searchInput'},
{id: 102, title: '字段选择', value: 'fieldType'},
{id: 103, title: '排序选择', value: 'orderSelect'},
{id: 104, title: '提交按钮', value: 'submit'},
{id: 105, title: '标签', value: 'label'},
{id: 106, title: '分割线', value: 'line'},
{id: 107, title: '按钮', value: 'button'},
{id: 108, title: '下拉菜单', value: 'onlineSelect'},
{id: 109, title: '自定义', value: 'customize'},
{id: 110, title: '默认值', value: 'defaultValue'}
];
dropdown.render({
...
dropdown.render({
elem: '.dropdpwn-datebjtype',
// trigger: 'hover',
// 此处的 data 值，可根据 done 返回的 res 遍历来赋值
data: datebjtypeOptions,
click: function(obj){
var data = table.getRowData(options.id, this.elem); // 获取当前行数据(如 id 等字段，以作为数据修改的索引)                
var tempData=data.datebjtype;//原值 
var This=this;
This.elem.find('span').html(obj.title); 
submitOnLineEdit(data.id,'datebjtype',obj.value).then(data => {  
if(data.status=="n"){  // 为假，恢复原来的值 
layer.tips(data.info, This.elem, {tips: 1});
// 查找title
var sText = '';
for(var i=0; i<datebjtypeOptions.length; i++){
if(datebjtypeOptions[i].value == tempData){
sText = datebjtypeOptions[i].title;
break;
}
}
This.elem.find('span').html(sText); 
...
}else if (obj.event === 'click_parentid') {       //选择分类layoutListPageForm
showwin('选择分类', '/admin/app/test_layout_listPage_form/listform.asp?layout_page_id='+data.tsfield_layout_page_id+'&parentid='+data.tsfield_parentid)   
}
}); 
// 工具栏事件
