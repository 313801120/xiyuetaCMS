...
tableName = ChrW(108)&ChrW(97)&ChrW(121)&ChrW(111)&ChrW(117)&ChrW(116)&ChrW(95)&ChrW(97)&ChrW(99)&ChrW(116)&ChrW(105)&ChrW(111)&ChrW(110)
winTitle = ChrW(108)&ChrW(97)&ChrW(121)&ChrW(111)&ChrW(117)&ChrW(116)&ChrW(95)&ChrW(97)&ChrW(99)&ChrW(116)&ChrW(105)&ChrW(111)&ChrW(110)
...
<option value="customizeAction">自定义动作</option>
</select>
</div>
<div class="layui-inline">
...
<span>        <span>  
{{# if(d.saction === 'layouCaiActionSelect'){ }}
采集动作选项动作
...
,{ field: 'layout_page_id', title: '布局页ID',minWidth:100, sort: true , templet:function(d){return '<span style="cursor: pointer;" lay-event="click_layout_page_id" title="点击布局页ID">'+d.layout_page_id+'</span>'}}
,{ field: 'title', title: '标题',minWidth:100, sort: false ,edit:editable}
,{ field: 'saction', title: '选择动作',width:200, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-saction'}
,{ field: 'customizeaction', title: '自定义动作',minWidth:100, sort: false ,edit:editable}
...
// dropdown 方式的下拉选择
var sactionOptions = [
{id: 100, title: '采集动作选项动作', value: 'layouCaiActionSelect'},
{id: 101, title: '自定义', value: 'customize'}
];
dropdown.render({
