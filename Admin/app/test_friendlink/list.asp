...
if instr(ChrW(124)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(124)&ChrW(104)&ChrW(116)&ChrW(116)&ChrW(112)&ChrW(117)&ChrW(114)&ChrW(108)&ChrW(124)&ChrW(116)&ChrW(97)&ChrW(114)&ChrW(103)&ChrW(101)&ChrW(116)&ChrW(124)&ChrW(115)&ChrW(111)&ChrW(114)&ChrW(116)&ChrW(114)&ChrW(97)&ChrW(110)&ChrW(107)&ChrW(124)&ChrW(110)&ChrW(111)&ChrW(102)&ChrW(111)&ChrW(108)&ChrW(108)&ChrW(111)&ChrW(119)&ChrW(124)&ChrW(105)&ChrW(115)&ChrW(116)&ChrW(104)&ChrW(114)&ChrW(111)&ChrW(117)&ChrW(103)&ChrW(104)&ChrW(124)&ChrW(124), ChrW(124)& lcase(b) &ChrW(124))=false then  
...
<!-- 下拉菜单 -->
<script type="text/html" id="TPL-dropdpwn-target">
<button class="layui-btn layui-btn-primary dropdpwn-target">
<span>        <span>  
{{# if(d.target === ''){ }}
当前页打开
...
,{ field: 'httpurl', title: '跳转网址',minWidth:100, sort: false ,edit:editable}
,{ field: 'target', title: '设置target',width:200, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-target'}
...
,{field: 'nofollow', title: '设置nofollow',width:130, sort: false, align:'center', templet:function(d){
return '<input type="checkbox" value="'+d.id+'" name="nofollow" lay-event="nofollow" lay-skin="switch" lay-text="设置|不设置" '+d.nofollow+' >'}}
...
// dropdown 方式的下拉选择
var targetOptions = [
{id: 100, title: '当前页打开', value: ''},
{id: 101, title: '新页打开(_blank)', value: '_blank'}
];
dropdown.render({
elem: '.dropdpwn-target',
// trigger: 'hover',
// 此处的 data 值，可根据 done 返回的 res 遍历来赋值
data: targetOptions,
click: function(obj){
var data = table.getRowData(options.id, this.elem); // 获取当前行数据(如 id 等字段，以作为数据修改的索引)                
var tempData=data.target;//原值 
var This=this;
This.elem.find('span').html(obj.title); 
submitOnLineEdit(data.id,'target',obj.value).then(data => {  
if(data.status=="n"){  // 为假，恢复原来的值 
layer.tips(data.info, This.elem, {tips: 1});
// 查找title
var sText = '';
for(var i=0; i<targetOptions.length; i++){
if(targetOptions[i].value == tempData){
sText = targetOptions[i].title;
break;
}
}
