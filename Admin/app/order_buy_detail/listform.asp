...
tableName = ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(95)&ChrW(98)&ChrW(117)&ChrW(121)&ChrW(95)&ChrW(100)&ChrW(101)&ChrW(116)&ChrW(97)&ChrW(105)&ChrW(108)
winTitle = ChrW(35746)&ChrW(21333)&ChrW(35814)&ChrW(32454)
dim msg,isTrue,addSql,id,orderid,ordernumber,memberid,articleid,count
id=getStrToNumber(request(ChrW(105)&ChrW(100)))
orderid=getStrToNumber(request(ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(105)&ChrW(100)))
if orderid="" then orderid=null
...
count=getStrToNumber(request(ChrW(99)&ChrW(111)&ChrW(117)&ChrW(110)&ChrW(116)))
...
rs(ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(105)&ChrW(100))=orderid
...
rs(ChrW(99)&ChrW(111)&ChrW(117)&ChrW(110)&ChrW(116))=count
...
orderid=rs(ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(105)&ChrW(100))
...
count=rs(ChrW(99)&ChrW(111)&ChrW(117)&ChrW(110)&ChrW(116))
end if
else
call showCheckAdminRule(ChrW(28155)&ChrW(21152) & winTitle)
end if
...
<input type='text' name='orderid' placeholder='请输入订单ID'autocomplete='off' class='layui-input' value="<%=orderid%>" >
</div><!--orderid-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-inline'>
<input type='text' name='articleid' placeholder='请输入商品ID'autocomplete='off' class='layui-input' value="<%=articleid%>" >
</div><!--articleid-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>数量</label>
<div class='layui-input-inline'>
<input type='text' name='count' placeholder='请输入数量'autocomplete='off' class='layui-input' value="<%=count%>" >
</div><!--count-->
</div>
</div>
<%if checkEnLanguage() then%>
