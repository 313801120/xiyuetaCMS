...
if ntop="" then ntop=null
sname=request(ChrW(115)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101))
npeixu=getStrToNumber(request(ChrW(110)&ChrW(112)&ChrW(101)&ChrW(105)&ChrW(120)&ChrW(117)))
if npeixu="" then npeixu=null
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(110)&ChrW(116)&ChrW(111)&ChrW(112)&ChrW(61)& ntop &ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(115)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(61)&ChrW(39)& sname &ChrW(39)
if id <>"" then
addsql=addsql & ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(109)&ChrW(105)&ChrW(100)&ChrW(60)&ChrW(62)&id
end if
...
if not rs.eof then
msg=ChrW(21517)&ChrW(31216)&ChrW(24050)&ChrW(32463)&ChrW(23384)&ChrW(22312)
else
if id="" then
rs.addnew
else
rs.close  
rs.open ChrW(115)&ChrW(101)&ChrW(108)&ChrW(101)&ChrW(99)&ChrW(116)&ChrW(32)&ChrW(42)&ChrW(32)&ChrW(102)&ChrW(114)&ChrW(111)&ChrW(109)&ChrW(32)&thisAddPrefix(tableName)&ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(109)&ChrW(105)&ChrW(100)&ChrW(61)&id,conn,1,3
end if 
rs(ChrW(110)&ChrW(116)&ChrW(111)&ChrW(112))=ntop
rs(ChrW(115)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101))=sname
rs(ChrW(110)&ChrW(112)&ChrW(101)&ChrW(105)&ChrW(120)&ChrW(117))=npeixu
...
ntop=rs(ChrW(110)&ChrW(116)&ChrW(111)&ChrW(112))
sname=rs(ChrW(115)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101))
npeixu=rs(ChrW(110)&ChrW(112)&ChrW(101)&ChrW(105)&ChrW(120)&ChrW(117))
...
<label class='layui-form-label'>ntop字段</label>
<div class='layui-input-inline layui-input-wrap'>
<select name="ntop" id="ntop" lay-filter="ntop" selected>
<option value="-1">≡ 作为一级栏目 ≡</option>
<%=columnClass_testmoreclass_SubInput(-1,id,ntop,"")%>
</select>
</div><!--ntop-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-inline layui-input-wrap'>
<input type='text' name='sname' placeholder='请输入名称' autocomplete='off' class='layui-input' value="<%=inputCL(sname)%>"  lay-verify='required'>
</div><!--sname-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>排序</label>
<div class='layui-input-inline layui-input-wrap'>
<input step="1" lay-affix="number" type='number' name='npeixu' placeholder='请输入排序' autocomplete='off' class='layui-input' value="<%=inputCL(npeixu)%>"  lay-verify='required'>
</div><!--npeixu-->
</div>
<div class='layui-form-item'>
