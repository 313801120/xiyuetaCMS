...
sql=IIF(sql="",ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32),sql & ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32))
sql =sql & ChrW(40)&ChrW(32)&ChrW(91)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(93)&ChrW(32)&ChrW(108)&ChrW(105)&ChrW(107)&ChrW(101)&ChrW(32)&ChrW(39)&ChrW(37) & keyword & ChrW(37)&ChrW(39)&ChrW(32)&ChrW(32)&ChrW(111)&ChrW(114)&ChrW(32)&ChrW(32)&ChrW(91)&ChrW(102)&ChrW(105)&ChrW(101)&ChrW(108)&ChrW(100)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(93)&ChrW(32)&ChrW(108)&ChrW(105)&ChrW(107)&ChrW(101)&ChrW(32)&ChrW(39)&ChrW(37) & keyword & ChrW(37)&ChrW(39)&ChrW(32)&ChrW(32)&ChrW(111)&ChrW(114)&ChrW(32)&ChrW(32)&ChrW(91)&ChrW(102)&ChrW(105)&ChrW(101)&ChrW(108)&ChrW(100)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(93)&ChrW(32)&ChrW(108)&ChrW(105)&ChrW(107)&ChrW(101)&ChrW(32)&ChrW(39)&ChrW(37) & keyword & ChrW(37)&ChrW(39)&ChrW(32)&ChrW(41) 
end if
End if
...
if instr(ChrW(124)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(124)&ChrW(102)&ChrW(105)&ChrW(101)&ChrW(108)&ChrW(100)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(124)&ChrW(102)&ChrW(105)&ChrW(101)&ChrW(108)&ChrW(100)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(124)&ChrW(102)&ChrW(105)&ChrW(101)&ChrW(108)&ChrW(100)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(124)&ChrW(116)&ChrW(101)&ChrW(120)&ChrW(116)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(97)&ChrW(104)&ChrW(101)&ChrW(105)&ChrW(103)&ChrW(104)&ChrW(116)&ChrW(124)&ChrW(122)&ChrW(104)&ChrW(117)&ChrW(106)&ChrW(105)&ChrW(97)&ChrW(102)&ChrW(105)&ChrW(101)&ChrW(108)&ChrW(100)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(102)&ChrW(105)&ChrW(103)&ChrW(124)&ChrW(108)&ChrW(97)&ChrW(98)&ChrW(101)&ChrW(108)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(100)&ChrW(105)&ChrW(116)&ChrW(124)&ChrW(100)&ChrW(105)&ChrW(118)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(124)&ChrW(105)&ChrW(110)&ChrW(112)&ChrW(117)&ChrW(116)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(124)&ChrW(115)&ChrW(111)&ChrW(114)&ChrW(116)&ChrW(114)&ChrW(97)&ChrW(110)&ChrW(107)&ChrW(124)&ChrW(105)&ChrW(115)&ChrW(116)&ChrW(104)&ChrW(114)&ChrW(111)&ChrW(117)&ChrW(103)&ChrW(104)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(49)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(50)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(51)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(52)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(53)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(54)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(55)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(56)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(57)&ChrW(124)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(97)&ChrW(109)&ChrW(49)&ChrW(48)&ChrW(124)&ChrW(117)&ChrW(112)&ChrW(100)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(102)&ChrW(105)&ChrW(103)&ChrW(98)&ChrW(116)&ChrW(110)&ChrW(124)&ChrW(124), ChrW(124)& lcase(b) &ChrW(124))=false then  
...
<!-- 下拉菜单 -->
<script type="text/html" id="TPL-dropdpwn-fieldtype">
<button class="layui-btn layui-btn-primary dropdpwn-fieldtype">
<span>        <span>  
{{# if(d.fieldtype === 'input'){ }}
文本
{{# } else if(d.fieldtype === 'textarea'){ }}
多行文本
{{# } else if(d.fieldtype === 'editor'){ }}
编辑器
{{# } else if(d.fieldtype === 'yesno'){ }}
是否
{{# } else if(d.fieldtype === 'radio'){ }}
单选框
{{# } else if(d.fieldtype === 'checkbox'){ }}
复选框
{{# } else if(d.fieldtype === 'number'){ }}
数字
{{# } else if(d.fieldtype === 'money'){ }}
货币
{{# } else if(d.fieldtype === 'date'){ }}
日期
{{# } else if(d.fieldtype === 'time'){ }}
时间
{{# } else if(d.fieldtype === 'uploadfile'){ }}
上传
{{# } else if(d.fieldtype === 'tags'){ }}
标签
{{# } else if(d.fieldtype === 'onlineSelect'){ }}
下拉菜单
{{# } else if(d.fieldtype === 'onlineRadioSelect'){ }}
下拉菜单Radio
{{# } else if(d.fieldtype === 'onlineCheckboxSelect'){ }}
下拉菜单Checkbox
{{# } else if(d.fieldtype === 'colorpicker'){ }}
颜色选择
{{# } else if(d.fieldtype === 'button'){ }}
按钮
{{# } else if(d.fieldtype === 'rating'){ }}
评分
{{# } else if(d.fieldtype === 'transfer'){ }}
穿梭框
{{# } else if(d.fieldtype === 'status'){ }}
状态提示
{{# } else if(d.fieldtype === 'handleAllAction'){ }}
动作字段
{{# } }}
</span></span>
...
<!-- 下拉菜单 -->
<script type="text/html" id="TPL-dropdpwn-divtype">
<button class="layui-btn layui-btn-primary dropdpwn-divtype">
<span>        <span>  
{{# if(d.divtype === 'inline'){ }}
内联inline
{{# } else if(d.divtype === 'block'){ }}
块block
{{# } }}
</span></span>
<i class="layui-icon layui-icon-down layui-font-12"></i>
...
<!-- 下拉菜单 -->
<script type="text/html" id="TPL-dropdpwn-inputtype">
<button class="layui-btn layui-btn-primary dropdpwn-inputtype">
<span>        <span>  
{{# if(d.inputtype === ''){ }}
默认
...
,{ field: 'title', title: '标题', sort: false ,edit:editable}
,{ field: 'fieldtitle', title: '字段标题', sort: true ,edit:editable}
,{ field: 'fieldname', title: '字段名称', sort: true ,edit:editable}
,{ field: 'fieldtype', title: '字段类型',width:130, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-fieldtype'}
,{ field: 'textareaheight', title: '文本域高',width:90, sort: false ,edit:editable}
,{ field: 'fieldconfig', title: '字段配置',width:100, sort: false }
,{ field: 'divtype', title: '表单块类型',width:140, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-divtype'}
,{ field: 'inputtype', title: 'input类型',width:120, sort: false , unresize: true, align: 'center', templet: '#TPL-dropdpwn-inputtype'}
...
{id: 100, title: '文本', value: 'input'},
{id: 101, title: '多行文本', value: 'textarea'},
{id: 102, title: '编辑器', value: 'editor'},
{id: 103, title: '是否', value: 'yesno'},
{id: 104, title: '单选框', value: 'radio'},
{id: 105, title: '复选框', value: 'checkbox'},
{id: 106, title: '数字', value: 'number'},
{id: 107, title: '货币', value: 'money'},
{id: 108, title: '日期', value: 'date'},
{id: 109, title: '时间', value: 'time'},
{id: 110, title: '上传', value: 'uploadfile'},
{id: 111, title: '标签', value: 'tags'},
{id: 112, title: '下拉菜单', value: 'onlineSelect'},
{id: 113, title: '下拉菜单Radio', value: 'onlineRadioSelect'},
{id: 114, title: '下拉菜单Checkbox', value: 'onlineCheckboxSelect'},
{id: 115, title: '颜色选择', value: 'colorpicker'},
{id: 116, title: '按钮', value: 'button'},
{id: 117, title: '评分', value: 'rating'},
{id: 118, title: '穿梭框', value: 'transfer'},
{id: 119, title: '状态提示', value: 'status'},
{id: 120, title: '动作字段', value: 'handleAllAction'}
];
dropdown.render({
elem: '.dropdpwn-fieldtype',
// trigger: 'hover',
...
var tempData=data.fieldtype;//原值 
var This=this;
This.elem.find('span').html(obj.title); 
submitOnLineEdit(data.id,'fieldtype',obj.value).then(data => {  
if(data.status=="n"){  // 为假，恢复原来的值 
layer.tips(data.info, This.elem, {tips: 1});
// 查找title
var sText = '';
for(var i=0; i<fieldtypeOptions.length; i++){
if(fieldtypeOptions[i].value == tempData){
sText = fieldtypeOptions[i].title;
break;
}
}
...
// dropdown 方式的下拉选择
var divtypeOptions = [
{id: 100, title: '内联inline', value: 'inline'},
{id: 101, title: '块block', value: 'block'}
];
dropdown.render({
elem: '.dropdpwn-divtype',
// trigger: 'hover',
// 此处的 data 值，可根据 done 返回的 res 遍历来赋值
data: divtypeOptions,
click: function(obj){
var data = table.getRowData(options.id, this.elem); // 获取当前行数据(如 id 等字段，以作为数据修改的索引)                
var tempData=data.divtype;//原值 
var This=this;
This.elem.find('span').html(obj.title); 
submitOnLineEdit(data.id,'divtype',obj.value).then(data => {  
if(data.status=="n"){  // 为假，恢复原来的值 
layer.tips(data.info, This.elem, {tips: 1});
// 查找title
var sText = '';
for(var i=0; i<divtypeOptions.length; i++){
if(divtypeOptions[i].value == tempData){
sText = divtypeOptions[i].title;
break;
}
}
This.elem.find('span').html(sText); 
...
{id: 100, title: '默认', value: ''},
{id: 101, title: '数字', value: 'number'},
{id: 102, title: '密码', value: 'password'},
{id: 103, title: '隐藏域', value: 'hidden'}
];
dropdown.render({
elem: '.dropdpwn-inputtype',
// trigger: 'hover',
// 此处的 data 值，可根据 done 返回的 res 遍历来赋值
data: inputtypeOptions,
click: function(obj){
var data = table.getRowData(options.id, this.elem); // 获取当前行数据(如 id 等字段，以作为数据修改的索引)                
var tempData=data.inputtype;//原值 
var This=this;
This.elem.find('span').html(obj.title); 
submitOnLineEdit(data.id,'inputtype',obj.value).then(data => {  
if(data.status=="n"){  // 为假，恢复原来的值 
layer.tips(data.info, This.elem, {tips: 1});
// 查找title
var sText = '';
for(var i=0; i<inputtypeOptions.length; i++){
if(inputtypeOptions[i].value == tempData){
sText = inputtypeOptions[i].title;
break;
}
}
This.elem.find('span').html(sText); 
