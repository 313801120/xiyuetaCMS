...
dim msg,isTrue,sql,addSql,id,articleid,articlemessageid,stype,isthrough,createtime,updatetime,ip,tsfield_addr
...
articlemessageid=getStrToNumber(request(ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(109)&ChrW(101)&ChrW(115)&ChrW(115)&ChrW(97)&ChrW(103)&ChrW(101)&ChrW(105)&ChrW(100)))
if articlemessageid="" then articlemessageid=null
...
articlemessageid=rs(ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(109)&ChrW(101)&ChrW(115)&ChrW(115)&ChrW(97)&ChrW(103)&ChrW(101)&ChrW(105)&ChrW(100))
...
<div class='layui-form-item'>
<label class='layui-form-label'>文章留言ID：</label>
<div class='layui-input-block layui-input-wrap'>
<%=get_articlemessage_oneClassColumnName(articlemessageid)%>
</div><!--articlemessageid-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>类型：</label>
<div class='layui-input-block layui-input-wrap'>
<%=getOnLineSelectValue(ChrW(115)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(45)&ChrW(25903)&ChrW(25345)&ChrW(95)&ChrW(115)&ChrW(117)&ChrW(115)&ChrW(116)&ChrW(97)&ChrW(105)&ChrW(110)&ChrW(45)&ChrW(21453)&ChrW(23545)&ChrW(95)&ChrW(111)&ChrW(112)&ChrW(112)&ChrW(111)&ChrW(115)&ChrW(101),stype)%>
</div><!--stype-->
</div>
<div class='layui-form-item'>
