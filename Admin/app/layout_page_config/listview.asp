...
islist=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(108)&ChrW(105)&ChrW(115)&ChrW(116)))
if islist="" then islist=null
isaddedit=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(97)&ChrW(100)&ChrW(100)&ChrW(101)&ChrW(100)&ChrW(105)&ChrW(116)))
if isaddedit="" then isaddedit=null
isview=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(118)&ChrW(105)&ChrW(101)&ChrW(119)))
if isview="" then isview=null
isonlineedit=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(111)&ChrW(110)&ChrW(108)&ChrW(105)&ChrW(110)&ChrW(101)&ChrW(101)&ChrW(100)&ChrW(105)&ChrW(116)))
if isonlineedit="" then isonlineedit=null
isenglish=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(101)&ChrW(110)&ChrW(103)&ChrW(108)&ChrW(105)&ChrW(115)&ChrW(104)))
if isenglish="" then isenglish=null
inputonlycheck=getStrToNumber(request(ChrW(105)&ChrW(110)&ChrW(112)&ChrW(117)&ChrW(116)&ChrW(111)&ChrW(110)&ChrW(108)&ChrW(121)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)))
if inputonlycheck="" then inputonlycheck=null
isinputcheck=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(105)&ChrW(110)&ChrW(112)&ChrW(117)&ChrW(116)&ChrW(99)&ChrW(104)&ChrW(101)&ChrW(99)&ChrW(107)))
if isinputcheck="" then isinputcheck=null
isinputtwocolumn=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(105)&ChrW(110)&ChrW(112)&ChrW(117)&ChrW(116)&ChrW(116)&ChrW(119)&ChrW(111)&ChrW(99)&ChrW(111)&ChrW(108)&ChrW(117)&ChrW(109)&ChrW(110)))
if isinputtwocolumn="" then isinputtwocolumn=null
isaddpageview=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(97)&ChrW(100)&ChrW(100)&ChrW(112)&ChrW(97)&ChrW(103)&ChrW(101)&ChrW(118)&ChrW(105)&ChrW(101)&ChrW(119)))
if isaddpageview="" then isaddpageview=null
islistheadsort=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(108)&ChrW(105)&ChrW(115)&ChrW(116)&ChrW(104)&ChrW(101)&ChrW(97)&ChrW(100)&ChrW(115)&ChrW(111)&ChrW(114)&ChrW(116)))
...
isshowclick=getStrToNumber(request(ChrW(105)&ChrW(115)&ChrW(115)&ChrW(104)&ChrW(111)&ChrW(119)&ChrW(99)&ChrW(108)&ChrW(105)&ChrW(99)&ChrW(107)))
...
<%=layout_page_id%>      </div><!--layout_page_id-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>配置字段ID：</label>
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=layout_field_id%>      </div><!--layout_field_id-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=listitemwidth%>      </div><!--listitemwidth-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=noteleftico%>      </div><!--noteleftico-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>文本注释：</label>
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=noterighttext%>      </div><!--noterighttext-->
</div>
<div class='layui-form-item'>
