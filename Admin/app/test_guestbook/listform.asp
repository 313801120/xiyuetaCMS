...
dim msg,isTrue,sql,addSql,id,title,guestname,tel,email,address,bodycontent,reply,replydatetime,isthrough
...
replydatetime=request(ChrW(114)&ChrW(101)&ChrW(112)&ChrW(108)&ChrW(121)&ChrW(100)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(116)&ChrW(105)&ChrW(109)&ChrW(101))
if replydatetime="" then replydatetime=null
...
rs(ChrW(114)&ChrW(101)&ChrW(112)&ChrW(108)&ChrW(121)&ChrW(100)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(116)&ChrW(105)&ChrW(109)&ChrW(101))=replydatetime
...
replydatetime=rs(ChrW(114)&ChrW(101)&ChrW(112)&ChrW(108)&ChrW(121)&ChrW(100)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(116)&ChrW(105)&ChrW(109)&ChrW(101))
...
<div class='layui-input-inline layui-input-wrap'>
<input type='text' name='address' placeholder='请输入地址' autocomplete='off' class='layui-input' value="<%=inputCL(address)%>" >
</div><!--address-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>留言内容</label>
<div class='layui-input-block layui-input-wrap'>
<textarea name='bodycontent' <%=IIF(request(ChrW(101)&ChrW(100)&ChrW(105)&ChrW(116)&ChrW(111)&ChrW(114)) <>ChrW(110)&ChrW(111),ChrW(32)&ChrW(105)&ChrW(100)&ChrW(61)&ChrW(39)&ChrW(98)&ChrW(111)&ChrW(100)&ChrW(121)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(116)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(39),"")%> placeholder='请输入留言内容' class='layui-textarea'><%=inputCL(bodycontent)%></textarea>
</div><!--bodycontent-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>回复内容</label>
<div class='layui-input-block layui-input-wrap'>
<textarea name='reply' <%=IIF(request(ChrW(101)&ChrW(100)&ChrW(105)&ChrW(116)&ChrW(111)&ChrW(114)) <>ChrW(110)&ChrW(111),ChrW(32)&ChrW(105)&ChrW(100)&ChrW(61)&ChrW(39)&ChrW(114)&ChrW(101)&ChrW(112)&ChrW(108)&ChrW(121)&ChrW(39),"")%> placeholder='请输入回复内容' class='layui-textarea'><%=inputCL(reply)%></textarea>
</div><!--reply-->
</div>
<div class='layui-form-item'>
...
<input type='text' name='replydatetime' placeholder='请输入回复时间' autocomplete='off' class='layui-input date' value="<%=replydatetime%>" >
</div><!--replydatetime-->
</div>
<div class='layui-form-item'>
...
//编辑器初始化
var editor_reply = layui.tinymce;
var edit = editor_reply.render({
selector: "#reply",
height: 500,
images_upload_handler: function (blobInfo, success, failure) {
var formData = new FormData();
...
// 时间选择器 for replydatetime
lay("input[name='replydatetime']").each(function() {
laydate.render({
elem: this,
trigger: 'click',
