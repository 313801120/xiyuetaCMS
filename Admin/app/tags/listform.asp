...
tableName = ChrW(116)&ChrW(97)&ChrW(103)&ChrW(115)
winTitle = ChrW(25991)&ChrW(31456)&ChrW(26631)&ChrW(31614)
...
if not rs.eof then
msg=ChrW(26631)&ChrW(31614)&ChrW(21517)&ChrW(24050)&ChrW(32463)&ChrW(28155)&ChrW(21152)&ChrW(36807)
else
if id="" then
rs.addnew
else
...
<input type='text' name='title' placeholder='请输入标签名'autocomplete='off' class='layui-input' value="<%=title%>" >
</div><!--title-->
</div>
<div class='layui-form-item'>
