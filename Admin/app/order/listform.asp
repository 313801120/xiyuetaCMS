...
tableName = ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)
winTitle = ChrW(35746)&ChrW(21333)
dim msg,isTrue,addSql,id,ordernumber,memberid,articleidlist,buy_number,total_price,isthrough
id=getStrToNumber(request(ChrW(105)&ChrW(100)))
ordernumber=request(ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(110)&ChrW(117)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114))
memberid=getStrToNumber(request(ChrW(109)&ChrW(101)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114)&ChrW(105)&ChrW(100)))
if memberid="" then memberid=null
articleidlist=request(ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100)&ChrW(108)&ChrW(105)&ChrW(115)&ChrW(116))
buy_number=getStrToNumber(request(ChrW(98)&ChrW(117)&ChrW(121)&ChrW(95)&ChrW(110)&ChrW(117)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114)))
if buy_number="" then buy_number=null
total_price=getStrToNumber(request(ChrW(116)&ChrW(111)&ChrW(116)&ChrW(97)&ChrW(108)&ChrW(95)&ChrW(112)&ChrW(114)&ChrW(105)&ChrW(99)&ChrW(101)))
if total_price="" then total_price=null
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(110)&ChrW(117)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114)&ChrW(61)&ChrW(39)& ordernumber &ChrW(39)
if id <>"" then
...
if not rs.eof then
msg=ChrW(35746)&ChrW(21333)&ChrW(21495)&ChrW(24050)&ChrW(32463)&ChrW(23384)&ChrW(22312)
else
if id="" then
rs.addnew
else
...
rs(ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(110)&ChrW(117)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114))=ordernumber
rs(ChrW(109)&ChrW(101)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114)&ChrW(105)&ChrW(100))=memberid
rs(ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100)&ChrW(108)&ChrW(105)&ChrW(115)&ChrW(116))=articleidlist
rs(ChrW(98)&ChrW(117)&ChrW(121)&ChrW(95)&ChrW(110)&ChrW(117)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114))=buy_number
rs(ChrW(116)&ChrW(111)&ChrW(116)&ChrW(97)&ChrW(108)&ChrW(95)&ChrW(112)&ChrW(114)&ChrW(105)&ChrW(99)&ChrW(101))=total_price
...
ordernumber=rs(ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(110)&ChrW(117)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114))
memberid=rs(ChrW(109)&ChrW(101)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114)&ChrW(105)&ChrW(100))
articleidlist=rs(ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100)&ChrW(108)&ChrW(105)&ChrW(115)&ChrW(116))
buy_number=rs(ChrW(98)&ChrW(117)&ChrW(121)&ChrW(95)&ChrW(110)&ChrW(117)&ChrW(109)&ChrW(98)&ChrW(101)&ChrW(114))
total_price=rs(ChrW(116)&ChrW(111)&ChrW(116)&ChrW(97)&ChrW(108)&ChrW(95)&ChrW(112)&ChrW(114)&ChrW(105)&ChrW(99)&ChrW(101))
...
<input type='text' name='ordernumber' placeholder='请输入订单号'autocomplete='off' class='layui-input' value="<%=ordernumber%>" >
</div><!--ordernumber-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>会员ID</label>
<div class='layui-input-inline'>
<input type='text' name='memberid' placeholder='请输入会员ID'autocomplete='off' class='layui-input' value="<%=memberid%>" >
</div><!--memberid-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>商品列表</label>
<div class='layui-input-inline'>
<input type='text' name='articleidlist' placeholder='请输入商品列表'autocomplete='off' class='layui-input' value="<%=articleidlist%>" >
</div><!--articleidlist-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>产品数量</label>
<div class='layui-input-inline'>
<input type='text' name='buy_number' placeholder='请输入产品数量'autocomplete='off' class='layui-input' value="<%=buy_number%>" >
</div><!--buy_number-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>总价格</label>
<div class='layui-input-inline'>
<input type='text' name='total_price' placeholder='请输入总价格'autocomplete='off' class='layui-input' value="<%=total_price%>" >
</div><!--total_price-->
</div>
<div class='layui-form-item'>
