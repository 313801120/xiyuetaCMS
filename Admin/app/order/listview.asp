...
dim msg,isTrue,addSql,id,ordernumber,articleidlist,buy_number,total_price,isthrough,createtime
...
<%=ordernumber%>      </div><!--ordernumber-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>商品列表：</label>
<div class='layui-input-inline' style='line-height:40px;color: #999;'>
<%=articleidlist%>      </div><!--articleidlist-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>产品数量：</label>
<div class='layui-input-inline' style='line-height:40px;color: #999;'>
<%=buy_number%>      </div><!--buy_number-->
</div>
<div class='layui-form-item'>
