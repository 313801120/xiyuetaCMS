...
tableName = ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(99)&ChrW(111)&ChrW(117)&ChrW(110)&ChrW(116)
winTitle = ChrW(25991)&ChrW(31456)&ChrW(32479)&ChrW(35745)
...
sql=IIF(sql="",ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32),sql & ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32))
sql =sql & ChrW(40)&ChrW(32)&ChrW(91)&ChrW(115)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(93)&ChrW(32)&ChrW(108)&ChrW(105)&ChrW(107)&ChrW(101)&ChrW(32)&ChrW(39)&ChrW(37) & keyword & ChrW(37)&ChrW(39)&ChrW(32)&ChrW(41) 
end if
End if
...
{{# if(d.stype === 'view'){ }}
浏览
{{# } else if(d.stype === 'fabulous'){ }}
赞
{{# } else if(d.stype === 'good'){ }}
好
{{# } else if(d.stype === 'bad'){ }}
坏
{{# } }}
...
,{ field: 'count', title: '统计数',width:80, sort: false }
...
// dropdown 方式的下拉选择
var stypeOptions = [
{id: 100, title: '浏览', value: 'view'},
{id: 101, title: '赞', value: 'fabulous'},
{id: 102, title: '好', value: 'good'},
{id: 103, title: '坏', value: 'bad'}
];
dropdown.render({
elem: '.dropdpwn-stype',
// trigger: 'hover',
