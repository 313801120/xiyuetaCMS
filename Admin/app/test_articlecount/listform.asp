...
dim msg,isTrue,sql,addSql,id,articleid,stype,count,isthrough,bodycontent
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100)&ChrW(61)& articleid &ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(115)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(61)&ChrW(39)& stype &ChrW(39)
if id <>"" then
...
<div class='layui-input-inline layui-input-wrap'>
<%=showOnLineSelectHtml(ChrW(115)&ChrW(116)&ChrW(121)&ChrW(112)&ChrW(101)&ChrW(45)&ChrW(27983)&ChrW(35272)&ChrW(95)&ChrW(118)&ChrW(105)&ChrW(101)&ChrW(119)&ChrW(45)&ChrW(36190)&ChrW(95)&ChrW(102)&ChrW(97)&ChrW(98)&ChrW(117)&ChrW(108)&ChrW(111)&ChrW(117)&ChrW(115)&ChrW(45)&ChrW(22909)&ChrW(95)&ChrW(103)&ChrW(111)&ChrW(111)&ChrW(100)&ChrW(45)&ChrW(22351)&ChrW(95)&ChrW(98)&ChrW(97)&ChrW(100),stype)%>
</div><!--stype-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>统计数</label>
<div class='layui-input-inline layui-input-wrap'>
<input step="1" lay-affix="number" type='number' name='count' placeholder='请输入统计数' autocomplete='off' class='layui-input' value="<%=inputCL(count)%>" >
</div><!--count-->
</div>
<div class='layui-form-item'>
