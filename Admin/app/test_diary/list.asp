...
tableName = ChrW(100)&ChrW(105)&ChrW(97)&ChrW(114)&ChrW(121)
winTitle = ChrW(26085)&ChrW(35760)
...
<option value="order by writedatetime desc">writedatetime倒排序</option>
<option value="order by writedatetime asc">writedatetime正排序</option>
</select>
</div>
<div class="layui-inline">  
...
<script type="text/html" id="TPL-laydate-writedatetime">
<input class="layui-input laydate-writedatetime time" placeholder="选择日期" value="{{= d.writedatetime || '' }}">
</script>
...
,{ field: 'title', title: '标题',minWidth:100, sort: false }
,{ field: 'weather', title: '天气',width:100, sort: false }
,{ field: 'writedatetime', title: '日记时间',width:160, sort: false }
,{ field: 'bodycontent', title: '备注',minWidth:100, sort: false }
...
// 更新数据中对应的字段
data.writedatetime = value; 
submitOnLineEdit(data.id,'writedatetime',value).then(res => {   
if(res.status=="n"){  // 为假，恢复原来的值 
layer.tips(res.info, This.elem, {tips: 1});
$(This.elem).val(tempData);                        
data.writedatetime = tempData;
}
}) 
}
});
