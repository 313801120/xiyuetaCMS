...
dim msg,isTrue,sql,addSql,id,title,weather,writedatetime,bodycontent
...
if writedatetime="" then writedatetime=null
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(61)&ChrW(39)& title &ChrW(39)&ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(119)&ChrW(101)&ChrW(97)&ChrW(116)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(61)&ChrW(39)& weather &ChrW(39)&ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)&ChrW(119)&ChrW(114)&ChrW(105)&ChrW(116)&ChrW(101)&ChrW(100)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(116)&ChrW(105)&ChrW(109)&ChrW(101)&ChrW(61)&getTimeFuHao()&writedatetime&getTimeFuHao()&""
if id <>"" then
...
writedatetime=rs(ChrW(119)&ChrW(114)&ChrW(105)&ChrW(116)&ChrW(101)&ChrW(100)&ChrW(97)&ChrW(116)&ChrW(101)&ChrW(116)&ChrW(105)&ChrW(109)&ChrW(101))
...
<input type='text' name='writedatetime' placeholder='请输入日记时间' autocomplete='off' class='layui-input date' value="<%=writedatetime%>"  lay-verify='required'>
</div><!--writedatetime-->
</div>
<div class='layui-form-item'>
...
// 时间选择器 for writedatetime
lay("input[name='writedatetime']").each(function() {
laydate.render({
elem: this,
trigger: 'click',
