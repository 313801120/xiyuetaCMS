...
dim msg,isTrue,sql,addSql,id,title,count,isthrough,createtime,updatetime
...
<div class='layui-form-item'>
<label class='layui-form-label'>初次搜索时间：</label>
<div class='layui-input-inline' style='line-height:40px;color: #999;'>
<%=createtime%>      </div><!--createtime-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>最后搜索时间：</label>
<div class='layui-input-inline' style='line-height:40px;color: #999;'>
