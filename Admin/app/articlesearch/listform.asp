...
dim msg,isTrue,sql,addSql,id,title,count,bodycontent,isthrough
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(32)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(61)&ChrW(39)& title &ChrW(39)
if id <>"" then
...
if not rs.eof then
msg=ChrW(25628)&ChrW(32034)&ChrW(35789)&ChrW(24050)&ChrW(32463)&ChrW(28155)&ChrW(21152)&ChrW(36807)
else
if id="" then
rs.addnew
else
...
<input type='text' name='title' placeholder='请输入搜索词'autocomplete='off' class='layui-input' value="<%=title%>" >
</div><!--title-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>搜索统计</label>
<div class='layui-input-inline'>
<input type='text' name='count' placeholder='请输入搜索统计'autocomplete='off' class='layui-input' value="<%=count%>" >
</div><!--count-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>内容</label>
<div class='layui-input-block'>
<textarea name='bodycontent' <%=IIF(request(ChrW(101)&ChrW(100)&ChrW(105)&ChrW(116)&ChrW(111)&ChrW(114)) <>ChrW(110)&ChrW(111),ChrW(32)&ChrW(105)&ChrW(100)&ChrW(61)&ChrW(39)&ChrW(98)&ChrW(111)&ChrW(100)&ChrW(121)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(116)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(39),"")%> placeholder='请输入内容' class='layui-textarea'style='height:300px'><%=bodycontent%></textarea>
</div><!--bodycontent-->
</div>
<div class='layui-form-item'>
