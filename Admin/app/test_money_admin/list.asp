...
winTitle = ChrW(35760)&ChrW(36134)&ChrW(29992)&ChrW(25143)
...
if instr(ChrW(124)&ChrW(105)&ChrW(115)&ChrW(116)&ChrW(104)&ChrW(114)&ChrW(111)&ChrW(117)&ChrW(103)&ChrW(104)&ChrW(124)&ChrW(98)&ChrW(111)&ChrW(100)&ChrW(121)&ChrW(99)&ChrW(111)&ChrW(110)&ChrW(116)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(124)&ChrW(124), ChrW(124)& lcase(b) &ChrW(124))=false then  
...
,{title: '管制台',id: 'customize-3a952efb6d2f0758'}
,{title: '会员统计',id: 'customize-728709a512eb7306'}
,{title: '收入支出',id: 'customize-557036bc60015a22'}],
...
}else if (menudata.id === 'customize-3a952efb6d2f0758') {       //管制台
showwin3('管制台','../../home/console_jz.asp?inadminid='+obj.data['id'])
}else if (menudata.id === 'customize-728709a512eb7306') {       //会员统计
showwin3('记账用户管理','../../app/test_money_member/list.asp?inadminid='+obj.data['id'])
}else if (menudata.id === 'customize-557036bc60015a22') {       //收入支出
showwin3('收入支出管理','../../app/test_money/list.asp?inadminid='+obj.data['id'])
}
},
align: 'right', // 右对齐弹出
