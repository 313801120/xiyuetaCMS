...
dim msg,isTrue,sql,addSql,parentid,columnname,columnenname,sortrank,isthrough,id
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(99)&ChrW(111)&ChrW(108)&ChrW(117)&ChrW(109)&ChrW(110)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101)&ChrW(61)&ChrW(39)& columnname &ChrW(39)
if id <>"" then
...
if not rs.eof then
msg=ChrW(23548)&ChrW(33322)&ChrW(21517)&ChrW(24050)&ChrW(32463)&ChrW(23384)&ChrW(22312)
else
if id="" then
rs.addnew
else
...
e.open ChrW(115)&ChrW(101)&ChrW(108)&ChrW(101)&ChrW(99)&ChrW(116)&ChrW(32)&ChrW(42)&ChrW(32)&ChrW(102)&ChrW(114)&ChrW(111)&ChrW(109)&ChrW(32)&ChrW(32)& getTableFieldFuHao(db_PREFIX &ChrW(120)&ChrW(105)&ChrW(121)&ChrW(117)&ChrW(101)&ChrW(116)&ChrW(97)&ChrW(99)&ChrW(108)&ChrW(97)&ChrW(115)&ChrW(115))&ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100)&ChrW(61)&a & d &ChrW(32)&ChrW(111)&ChrW(114)&ChrW(100)&ChrW(101)&ChrW(114)&ChrW(32)&ChrW(98)&ChrW(121)&ChrW(32)&ChrW(115)&ChrW(111)&ChrW(114)&ChrW(116)&ChrW(114)&ChrW(97)&ChrW(110)&ChrW(107)&ChrW(32)&ChrW(97)&ChrW(115)&ChrW(99),conn,1,1
while not e.eof  
h=""
if c <>"" then
...
<label class='layui-form-label'>选择分类xiyuetaclass-parentid</label>
<div class='layui-input-inline layui-input-wrap'>
<select name="parentid" id="parentid" lay-filter="parentid" selected>
<option value="-1">≡ 作为一级栏目 ≡</option>
<%=columnClass_xiyuetaclass_SubInput(-1,id,parentid,"")%>
</select>
</div><!--parentid-->
</div>
<div class='layui-form-item'>
...
<div class='layui-input-inline layui-input-wrap'>
<input type='text' name='columnname' placeholder='请输入栏目名称' autocomplete='off' class='layui-input' value="<%=inputCL(columnname)%>"  lay-verify='required'>
</div>
<div class="layui-form-mid layui-text-em">栏目中文名称</div><!--columnname-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>栏目英文名</label>
<div class='layui-input-inline layui-input-wrap'>
<input type='text' name='columnenname' placeholder='请输入栏目英文名' autocomplete='off' class='layui-input' value="<%=inputCL(columnenname)%>" >
</div><!--columnenname-->
</div>
<div class='layui-form-item'>
