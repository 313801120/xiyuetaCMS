...
<%=get_layout_database_table_oneClassColumnName(layout_database_table_id)%>
...
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=IIF(isfieldselct=0,ChrW(21542),ChrW(26159))%>
</div><!--isfieldselct-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>显示搜索排序：</label>
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=IIF(issortselct=0,ChrW(21542),ChrW(26159))%>
</div><!--issortselct-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>显开始时间：</label>
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=IIF(isstarttime=0,ChrW(21542),ChrW(26159))%>
</div><!--isstarttime-->
</div>
<div class='layui-form-item'>
<label class='layui-form-label'>显结束时间：</label>
<div class='layui-input-inline layui-input-wrap' style='line-height:40px;color: #999;'>
<%=IIF(isendtime=0,ChrW(21542),ChrW(26159))%>
</div><!--isendtime-->
</div>
</div>
</div>
