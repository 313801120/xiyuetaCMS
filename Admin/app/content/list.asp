...
, { field: 'title', title: '名称',minWidth:100, sort: true,edit:editable } 
// ,{field: 'tsfield001',width:100, title: '图片总数', templet:function(d){
//      return '<span style="cursor: pointer;" lay-event="tsfield001" title="点击管理">'+d.tsfield001+'</span>'}}
