...
call openconn() 
dim num,page,stemp,sql1,sql,mysql,currentPage,perpage,page_count,i,n,sS,sHr,totalrec,columnName,id,title,parentid
...
If Request("act") = "list" Then  
    ...
    If Not rs.EOF Then
        ...
        While (Not rs.EOF) And(Not page_count = rs.PageSize)
	       ...
	       stemp = stemp & "{""id"":""" & rs("id") & """,""parentid"":""" & columnName & """,""title"":""" & rs("title") & """,""createTime"":""" & rs("createTime") & """}" &sHr & "" 
...
elseif request("act")="del" then
  conn.execute"delete from ["& db_PREFIX &"articleDetail] where id="&request("id")
