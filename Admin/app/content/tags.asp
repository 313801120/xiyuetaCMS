...
dim fieldType,addsql,startIndex,endIndex,sql2,pageSize,nCount,x,maxpage,iPageSize,msg,sex
dim splxx,columnname
...
idList=getColumAllID(ChrW(45)&ChrW(49))
...
End if  
If parentid <> "" and parentid <>ChrW(45)&ChrW(49) Then
sIdList=parentid

sTempId=getColumAllID(parentid)
if sTempId <>"" then
sIdList= sIdList & ChrW(44)  & sTempId
end if
sql=IIF(sql="",ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32),sql & ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32)) 

sql = sql & ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100)&ChrW(32)&ChrW(105)&ChrW(110)&ChrW(40)& sIdList & ChrW(41)
End if 
...
sql=IIF(sql="",ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32),sql & ChrW(32)&ChrW(97)&ChrW(110)&ChrW(100)&ChrW(32))
sql =sql & ChrW(40)&ChrW(32)&ChrW(91)&ChrW(116)&ChrW(105)&ChrW(116)&ChrW(108)&ChrW(101)&ChrW(93)&ChrW(32)&ChrW(108)&ChrW(105)&ChrW(107)&ChrW(101)&ChrW(32)&ChrW(39)&ChrW(37) & Request(ChrW(107)&ChrW(101)&ChrW(121)) & ChrW(37)&ChrW(39)&ChrW(32)&ChrW(32)&ChrW(41) 
...
rsx.open ChrW(115)&ChrW(101)&ChrW(108)&ChrW(101)&ChrW(99)&ChrW(116)&ChrW(32)&ChrW(42)&ChrW(32)&ChrW(102)&ChrW(114)&ChrW(111)&ChrW(109)&ChrW(32)&ChrW(91)& db_PREFIX &ChrW(119)&ChrW(101)&ChrW(98)&ChrW(99)&ChrW(111)&ChrW(108)&ChrW(117)&ChrW(109)&ChrW(110)&ChrW(93)&ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(105)&ChrW(100)&ChrW(61)&splxx(i-1),conn,1,1
if not rsx.eof then
if rsx(ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100)) <>-1 then
columnname=getSubColumSort(rsx(ChrW(112)&ChrW(97)&ChrW(114)&ChrW(101)&ChrW(110)&ChrW(116)&ChrW(105)&ChrW(100)),"")  & rsx(ChrW(99)&ChrW(111)&ChrW(108)&ChrW(117)&ChrW(109)&ChrW(110)&ChrW(110)&ChrW(97)&ChrW(109)&ChrW(101))
else
...
<!-- <button class="layui-btn" onclick="showwin('添加会员','tagsform.asp?')">添加</button>
...
, { field: 'sortrank', title: '排序', width: 70, minWidth: 70, sort: false,edit:editable }
...
showwin('编辑<%=winTitle%>', 'tagsform.asp?id=' + pid)
...
showwin('编辑<%=winTitle%>', 'tagsform.asp?id=' + data.id)
}if(menudata.id === 'edit2'){
// layer.msg('查看操作，当前行 ID:'+ data.id);
showwin('编辑<%=winTitle%>', 'tagsform.asp?id=' + data.id+"&editor=no") 
...
showwin('添加账务信息','/static/admin/app/finance/tagsform.asp?userid=' + pid)   
}
});
// 工具栏事件
...
break;
case 'add':
showwin('添加<%=winTitle%>','tagsform.asp?')
break;
case 'batchdel':
batchDelSelected();
break;
