...
dim msg,isTrue,sql,addSql,id,articleid,parentid,guestname,tel,email,bodycontent,isthrough
...
isTrue=true
if isTrue=true then
addsql=ChrW(32)&ChrW(119)&ChrW(104)&ChrW(101)&ChrW(114)&ChrW(101)&ChrW(32)&ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100)&ChrW(61)&ChrW(45)&ChrW(57)
if id <>"" then
...
if not rs.eof then
msg=ChrW(97)&ChrW(114)&ChrW(116)&ChrW(105)&ChrW(99)&ChrW(108)&ChrW(101)&ChrW(105)&ChrW(100)&ChrW(61)&ChrW(45)&ChrW(57)&ChrW(24050)&ChrW(32463)&ChrW(28155)&ChrW(21152)&ChrW(36807)
else
if id="" then
rs.addnew
else
...
<div class='layui-input-inline'>
<input type='text' name='parentid' placeholder='请输入给TA回复'autocomplete='off' class='layui-input' value="<%=parentid%>" >
</div><!--parentid-->
</div>
<div class='layui-form-item'>
