...
function useTpl2022(tpl) 
  ...
  '复制CSS文件'
  cssFolder="../../css/"
  call createfolder(cssFolder)
  cssFilePath=tplFolderPath & "/" &  tpl & ".css"
  toCssFilePath=cssFolder & tpl & ".css"
  if checkfile(toCssFilePath)=false then
    call copyFile(cssFilePath,toCssFilePath)
  end if
...
%>
                        <div class="layui-col-md2 layui-col-sm4" style="padding:10px;">
                            <div class="cmdlist-container" style="border:1px solid #000;background:#fff;">
                                <img src="../../tpl/<%=folderName & "/" &folderName&".jpg"%>">
