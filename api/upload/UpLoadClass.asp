...
function Error2Info(Error)
	...
	case 0: Error2Info = "上传成功。"
	case 1: Error2Info = "上传失败，文件超过限制大小"
	case 2: Error2Info = "文件类型不允许"
	case 3: Error2Info = "文件大小超过限制，且文件类型不允许"
	case 4: Error2Info = "文件保存失败"
	case 5: Error2Info = "文件上传数量超出限制"
	end select
end function
