...
function(t) {
    ...
    var c = function(t, i, a) {
        ...
        function() {
            ...
            s = o.find("head"),
            c = e(["<style>", "*{margin: 0; padding: 0;}", "body{padding: 3px; line-height: 20px; word-wrap: break-word; font: 14px Helvetica Neue,Helvetica,PingFang SC,Microsoft YaHei,Tahoma,Arial,sans-serif; -webkit-box-sizing: border-box !important; -moz-box-sizing: border-box !important; box-sizing: border-box !important;}", "a{color:#007aff; text-decoration:underline;}a:hover{color:#c00}", "p{margin-bottom: 10px;}", "img{display: inline-block; border: none; vertical-align: middle;max-width:95%;}", "pre{margin: 10px 0; padding: 10px; line-height: 20px; border: 1px solid #ddd; border-left-width: 6px; background-color: #F2F2F2; color: #333; font-family: Courier New; font-size:12px;}", "</style>"].join("")),
            u = o.find("body");
            s.append(c),
        ...
        s = {
            ...
            help: function() {
                i.open({
                    ...
                    content: ["/about/layedit/help.html", "no"]
                })
            }
        },
