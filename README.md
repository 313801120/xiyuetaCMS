...
## 简介
XiyuetaCMS v1.0.6 是一款基于 Classic ASP 的开源网站管理系统，支持 Access/SQL Server 多数据库，集 PC/移动/平板于一体，多语言（简体/繁体/英文）和动静态切换。内置后台管理、内容模型（新闻/产品/案例/下载/单页/留言等）、模板系统、上传中心、站点地图/RSS 以及安全与统计功能。
